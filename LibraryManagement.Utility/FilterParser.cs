...
// public static List<List<FilterCriteria>> ParseGroupedFilters(string? sFilters)
// {
...
//             // Optional: parse createdAt or other fields if needed
//             if (propPath.Last().Equals("createdAt", StringComparison.OrdinalIgnoreCase)
...
// public static IQueryable<T> ApplyFilters<T>(IQueryable<T> source, List<List<FilterCriteria>> groupedFilters)
// {
