...
public class BookController : ControllerBase
{
    ...
    // [HttpGet]
    // public async Task<ActionResult<List<BooksViewModel>>> GetAllBooks() {
    ...
    // public async Task<ActionResult<List<BooksViewModel>>> GetBooks([FromQuery] PaginationFilter paginationFilter) {

    //     var response  = await _bookService.GetPaginatedListOfBooks(paginationFilter);
